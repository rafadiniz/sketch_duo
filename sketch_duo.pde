...
void setup(){
 ...
 frameRate(60);
  ...
  float sp_amp_2, sp_dur_2, sp_rate_2, sp_pan_2, sp_out_2, buf_2 =2;
...
void draw(){
  ...
  text("_[]dUO", 10, 110);
   ...
   if (key == '1') {
    ...
    sy_pan = map(mouseY, 0, height,-0.8,random(-0.8,-0.4));
    sy_out = 0;
   
    sp_dur = map(mouseY, 0,height,0.05,2.0);
    sp_rate = map(mouseY, 0,height,1.0,1200.0);
    sp_pan = map(mouseY, 0, height,-0.8,random(-0.8,-0.4));
   ...
   if (key == '2') {
    ...
    sy_amp = random(0,250);
    sy_rate = 3;
    sy_pan = random(-0.8,-0.4);
    sy_out = 0;
    
    sp_dur = random(0.5,2.0);
    sp_rate = 1000;
    sp_pan = random(-0.8,-0.4);
    sp_amp = 150;
    sp_out = 12;
   ...
   if (key == '3') {
    ...
    sy_rate_2 = 5.8;
    sy_pan_2 = map(mouseY,0,height,0.0,1.0);
    sy_out_2 = 0;
    
    buf_2 = 2;
    sp_dur_2 = 0.01;
    sp_rate_2 = map(mouseY,0,width,10.5,252);
    sp_pan_2 = random(1.0,0.0);
